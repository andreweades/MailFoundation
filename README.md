...
Jeffrey Stedfast (MailKit/MimeKit). The goal is to bring those capabilities and
API ergonomics to Swift developers, with modern async/await support and a Swift-native
type system.
